...
$(document).ready(function() {
  /* Stroke */
  $('.b-link-flow').prepend('<div class="b-top-line"></div>');
  $('.b-link-flow').prepend('<div class="b-bottom-line"></div>');
  /* Fade */
...
$(window).on('ready', function() {
  var W = $(window).width();
  if(W < 767) {
    $('.items-has-submenu').on('click', function(){
      $('.items-has-submenu .submenu').toggleClass('open');
    });    
  }
})
